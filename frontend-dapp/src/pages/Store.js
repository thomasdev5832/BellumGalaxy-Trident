...
function Store() {
  ...
  const buyGame = async () => {
    ...
    try {
      ...
      // Obter o signer do walletClient
      // Verificar se o walletClient é compatível com ethers
      ...
      const usdcContract = new ethers.Contract(usdcSepoliaAdrees, USDCSepolia, signer);
